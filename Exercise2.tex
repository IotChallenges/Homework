...
loop() {
  ...
  if temperature > 34.0:
    resting_transmits = 0
    disable_ble_beacons()
    // while in-mouth, ignore unnecessary interrupt-based wakeups. If the MCUs power draw for processing motion interrupts is negligible, this can be removed
    ignore_interrupts(Wake_on_Motion_Interrupt)
